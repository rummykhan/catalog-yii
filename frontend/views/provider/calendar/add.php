        ...
        <div class="col-md-12">
            ...
            <div class="row hidden" id="update-rules-row">
                <div class="col-md-12 text-right">
                    <?php ActiveForm::begin(['action' => ['/provider/calendar-global-rules', 'provider_id' => $model->id]]) ?>
...
<?php Modal::begin([
    ...
    <div class="row hidden" id="update-date-rule">
        <div class="col-md-12">
            ...
            <?php ActiveForm::begin(['action' => ['/provided/calendar-date-rule', 'provider_id' => $model->id]]) ?>
